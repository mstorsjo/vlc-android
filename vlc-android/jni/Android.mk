...
LIBIOMX_SRC_FILES_jb := $(LIBIOMX_SRC_FILES_COMMON) $(LIBIOMX_SRC_FILES_HWBUFFER)
LIBIOMX_INCLUDES_jb := $(LIBIOMX_INCLUDES_COMMON) \
	$(ANDROID_SYS_HEADERS_JB)/frameworks/native/include \
	$(ANDROID_SYS_HEADERS_JB)/frameworks/av/include \
	$(ANDROID_SYS_HEADERS_JB)/system/core/include \
	$(ANDROID_SYS_HEADERS_JB)/hardware/libhardware/include
LIBIOMX_LDLIBS_jb := $(LIBIOMX_LDLIBS_COMMON) $(LIBIOMX_LDLIBS_HWBUFFER)
LIBIOMX_CFLAGS_jb := $(LIBIOMX_CFLAGS_COMMON) $(LIBIOMX_CFLAGS_HWBUFFER) -DANDROID_API=16
